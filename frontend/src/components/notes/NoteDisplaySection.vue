...
<template>
  <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4 mb-8">
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Destination</p>
      ...
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Dates</p>
        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ formatDateRange(note.date_from, note.date_to) }}</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Duration</p>
        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ calculateDuration(note.date_from, note.date_to) }}</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Travelers</p>
        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ note.number_of_people }}</p>
      </div>
    </div>
    ...
    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
      ...
      <div v-if="note.key_ideas && note.key_ideas.trim()" class="prose prose-gray dark:prose-invert max-w-none">
        <p class="text-gray-700 dark:text-gray-300 whitespace-pre-wrap leading-relaxed">{{ note.key_ideas }}</p>
      </div>
      <div v-else class="text-center py-8">
        ...
        <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Add some ideas by editing this note</p>
      </div>
    </div>
  </div>
</template>
