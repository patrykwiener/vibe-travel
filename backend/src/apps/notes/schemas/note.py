...
class NoteListOutSchema(BaseModel):
    """Schema for paginated list of notes response.

    This schema is used as output for the GET /notes endpoint.
    """

    items: list[NoteListItemOutSchema] = Field(
        ...,
